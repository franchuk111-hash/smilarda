    ...
    <>
      ...
      <section className="block"><div className="container">
        <Reveal className="seo-text">
          ...
          <p>Потрібен прорахунок? Зателефонуйте <a href="tel:+380977799513">+38 (097) 779 95 13</a> або залиште заявку на сторінці <Link href="/kontakty">Контакти</Link> — і майстер «Сміла Буд» безкоштовно виїде на об’єкт.</p>
        </Reveal>
      </div></section>
    </>
  );
